...
#ifndef __INET_MORPMLNEIGHBORTABLE_H
#define __INET_MORPMLNEIGHBORTABLE_H
 ...
 */
class INET_API MorpmlNeighborTable {
private:
    struct Neighbor {
...
public:
    ...
    friend std::ostream& operator<<(std::ostream &o, const MorpmlNeighborTable &t);
};
