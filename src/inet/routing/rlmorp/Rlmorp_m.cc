...
int RlmorpBeaconDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "buffPktNo") == 0) return baseIndex + 9;
...
std::string RlmorpBeaconDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_buffPktNo: return double2string(pp->getBuffPktNo());
        default: return "";
    }
}
...
void RlmorpAck::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->originalDestination);
...
void RlmorpAck::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->originalDestination);
...
unsigned int RlmorpAckDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_treeId
        0,    // FIELD_originalSource
        0,    // FIELD_originalDestination
        FD_ISEDITABLE,    // FIELD_deliveryTime
    };
...
int RlmorpAckDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    int baseIndex = base ? base->getFieldCount() : 0;
    if (strcmp(fieldName, "treeId") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "originalSource") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "originalDestination") == 0) return baseIndex + 2;
    if (strcmp(fieldName, "deliveryTime") == 0) return baseIndex + 3;
    return base ? base->findField(fieldName) : -1;
}
...
const char *RlmorpAckDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "int",    // FIELD_treeId
        "inet::Ipv4Address",    // FIELD_originalSource
        "inet::Ipv4Address",    // FIELD_originalDestination
        "omnetpp::simtime_t",    // FIELD_deliveryTime
    };
...
std::string RlmorpAckDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_originalDestination: return pp->getOriginalDestination().str();
        case FIELD_deliveryTime: return simtime2string(pp->getDeliveryTime());
        default: return "";
    }
}
