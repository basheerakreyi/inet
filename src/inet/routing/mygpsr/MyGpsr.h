...
#include "inet/routing/mygpsr/MyGpsr_m.h"
#include "inet/routing/mygpsr/PositionTable.h"
 ...
 *
 * For more information on the routing algorithm, see the MyGpsr paper
 * http://www.eecs.harvard.edu/~htk/publication/2000-mobi-karp-kung.pdf
 */

// KLUDGE implement position registry protocol instead of using a global variable
class INET_API MyGpsr : public RoutingProtocolBase, public cListener, public NetfilterBase::HookBase
{
  private:
    // MyGpsr parameters
